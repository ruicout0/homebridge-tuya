...
class GarageDoorAccessory extends BaseAccessory {
    ...
    _registerCharacteristics(dps) {
        ...
        const rawManufacturer = (this.device.context.manufacturer || '').trim().toLowerCase();
        if (rawManufacturer === GARAGE_DOOR_MANUFACTURER_KOGAN.toLowerCase()) {
            this.manufacturer = GARAGE_DOOR_MANUFACTURER_KOGAN;
        } else if (rawManufacturer === GARAGE_DOOR_MANUFACTURER_WOFEA.toLowerCase()) {
            this.manufacturer = GARAGE_DOOR_MANUFACTURER_WOFEA;
